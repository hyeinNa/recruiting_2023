          ...
          <div className="marketing_detail_activity_content_container">
            ...
            >
              ...
              <div className="marketing_description marketing_part1_description">
                이화이언은 재학생들이 직접 운영하고 있는 ‘이화를 사랑하는
                사람들을 위한' 비영리 집단입니다.
                <br />
            ...
            <div
              className="marketing_part2_container"
              data-aos="fade-up"
              data-aos-once="false"
            >
              ...
              <div className="marketing_description">
                이화이언 마케팅팀은 팀 회의를 거쳐 각 운영진별 주차에 맞게
                개인의 아이디어와 상상력을 가득 담은 개인 게시물을 기획합니다.
                <br />
                이후 팀원 간의 상호 피드백을 거쳐 본인의 아이디어를 실제
                게시물로 기획 및 구현하여 업로드하는 과정을 거치게 됩니다.
                <br />
            ...
            <div
              className="marketing_part3_contianer"
              data-aos="fade-up"
              data-aos-once="false"
            >
            ...
            <div
              className="marketing_part4_container"
              data-aos="fade-up"
              data-aos-once="false"
            >
              <div className="marketing_title">'마케팅 스터디 프로젝트'</div>
              <div className="marketing_description">
                이화이언 마케팅팀은 모든 팀원들이 보다 넓은 마케팅 커리어와
                시야를 구축할 수 있도록
                <br /> 2023년부터 추가적인 커리큘럼을 도입하여 진행하고
                있습니다.
                <br />
                상호 소통과 적절한 협업, 개인 아이데이션을 거쳐 진행되는
                체계적인 커리큘럼을 통해
