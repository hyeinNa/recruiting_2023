...
function MarketingStudyProject() {
  ...
  return (
    <div>
      <Header />
      <div className="marketing_study_project_container between_wrapper">
        <div className="marketing_study_project_inner_container">
          <div
            className="marketing_study_project_content_container"
            data-aos="fade-up"
            data-aos-once="false"
          >
                ...
                <div className="marketing_study_project_plan_inner_container">
                  ...
                  <ul className="marketing_study_project_plan_description">
                    <li className="plan_description1">
                      다양한 기업들의 대표 협업 툴인 ‘노션'의 운영 및 사용
                      체제에 익숙해지기 위한 목적에서부터 출발한 프로젝트입니다.
                      마케터에게 협업 속 개인의 역량 도출 및 기록은 생명!
                    </li>
                    <li>
                      ‘노션’을 활용하여 자기 자신의 커리어와 아이덴티티를 가장
                      잘 나타낼 수 있는 단 하나뿐인 마케팅 포트폴리오를 만들고,
                      상호 피드백을 거쳐 최고의 작업물을 도출해내는 제작
                      프로젝트입니다.
                    </li>
                  </ul>
                </div>
              ...
              <div className="marketing_study_project_plans">
                <div className="marketing_study_project_plan_inner_container">
                  ...
                  <ul className="marketing_study_project_plan_description">
                    ...
                    <li>
                      기업과의 협업, 보다 직접적인 실무 관여를 통해 마케터로서
                      한 발짝 가까이 다가갈 수 있는 기회를 마련하고자 합니다.
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="marketing_study_project_plan_inner_container">
                  ...
                  <ul className="marketing_study_project_plan_description">
                    ...
                    <li>
                      ...
                      개개인의 협업 능력 및 인사이트 도출 능력을 강화하고
                      실질적인 마케팅 커리어를 한 단계씩 쌓아가고자 하는
                      프로젝트입니다.
                    </li>
                  </ul>
                </div>
