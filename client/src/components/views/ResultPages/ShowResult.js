    ...
    <div classname="register_showResult">
      <div classname="register_showResult_container">
        <div classname="register_showResult_content_Wrapper">
          <div>안녕하세요. {name}님 이화이언 {cardinal_number}기 수습 운영진 모집에 1차 합격하신 것을 진심으로 축하드립니다!</div>

          <div>2차 면접은 하단에 기재된 일정에 따라 다대일 대면 면접으로 진행될 예정입니다.</div>
          <div>면접 일정 : ㅇㅇ월 ㅇㅇ일 ㅇ요일 ㅇㅇ시 ㅇㅇ분</div>
          <div>면접의 경우, 불가피하게 배정된 면접 시간에서 10분 내외로 지연될 수 있습니다.</div>

          <div>*추가적인 문의사항이 있는 경우, 마스터 000 (010-0000-0000)에게 연락 부탁드립니다.</div>
